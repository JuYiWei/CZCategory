...
#define CZ_SCREEN_PHONE_X_1242x2208       ([[UIScreen mainScreen] respondsToSelector:@selector(currentMode)] ? CGSizeEqualToSize([UIScreen mainScreen].currentMode.size, CGSizeMake(1242, 2208)) : NO)
#define CZ_SCREEN_PHONE_PLUS_1125x2436    ([[UIScreen mainScreen] respondsToSelector:@selector(currentMode)] ? CGSizeEqualToSize([UIScreen mainScreen].currentMode.size, CGSizeMake(1125, 2436)) : NO)
